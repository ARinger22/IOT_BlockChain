...
import './App.css';
// import IoT_deviceComponent from './component/IoT_device_component';
        ...
        <>
          <BrowserRouter>
            <Routes>
              ...
              {/* <Route path="/voting" element={<IoT_deviceComponent  contractInstance={contractInstance} account={accounts[0]} />} /> */}
            </Routes>
          </BrowserRouter>
        </>}
